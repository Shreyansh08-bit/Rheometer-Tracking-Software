...
class CustomTextIO(io.TextIOBase):
    ...
    def write(self, s):
        self.textbox.insert(tkinter.END, s)
        return len(s)

def redirect_output_to_textbox(textbox):
    sys.stdout = CustomTextIO(textbox)
    sys.stderr = CustomTextIO(textbox)  #Will print the error message or the reason of crash in text box
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        redirect_output_to_textbox(self.textbox)
